(function($){$.fn.tipuesearch=function(options){var set=$.extend({'show':99,'newWindow':false,'showURL':false,'showTitleCount':true,'minimumLength':2,'descriptiveWords':25,'highlightTerms':true,'highlightEveryTerm':true,'mode':'static','liveDescription':'*','liveContent':'*','contentLocation':'assets/tipuesearch/tipuesearch_content.json','debug':false},options);return this.each(function(){var tipuesearch_in={pages:[]};$.ajaxSetup({async:false});var tipuesearch_t_c=0;if(set.mode=='live')
